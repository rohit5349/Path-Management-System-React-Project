  ...
  return (
    <div>
      <div className="firstbox">
        ...
        <div className="location-container">
            <input type='text' placeholder='Enter Current Location' className='input1'/>
            <button onClick={addLocation} id='findlocation'> Add Location </button>
            <button onClick={deleteTask} id='delete'> Delete </button>
            <input type='text' placeholder='Enter Destination' className='input2'/>
            <button id='calculatepath' onClick={calculateAndDisplayShortestPath}>
               Short Route
            </button>
        </div>
